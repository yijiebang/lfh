...
import com.reinfo.ipoly.module.utils.WlpConstant;
...
public class BuildPpsMedGold  implements BuildPps  {
    ...
    public BuildPpsMedGold (IlfQuot quot, List<QuotPlanDetail> planList){
        this.quot = quot;
    ...
    public Pps buildPpsData() {
        ...
        pps.setM12SA(FunctionUtil.getValue(quot.getQuotPlan().toLowerCase(),quot.getQuotCcy(),"m12SA"));
