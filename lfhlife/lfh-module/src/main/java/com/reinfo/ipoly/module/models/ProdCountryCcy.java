...
public class ProdCountryCcy implements Serializable, Cloneable {
	...
	private static final String Table = "prod_country_ccy";
	private static final String Alias = "as_prod_country_ccy";
	...
	@Override
	public ProdCountryCcy clone() {
		ProdCountryCcy o = null;
		try{
			o = (ProdCountryCcy)super.clone();
